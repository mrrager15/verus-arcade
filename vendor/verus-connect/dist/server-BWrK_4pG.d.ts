...
declare function verusAuth(config: VerusConnectConfig): Router;

export { type Challenge as C, type Signer as S, type VerifiedLogin as V, type VerusConnectConfig as a, verusAuth as v };
